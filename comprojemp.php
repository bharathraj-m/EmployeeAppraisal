...
$pid=$_SESSION['eid'];
 ...
 $query = "SELECT distinct * from projects as p,employee as e where p_mgr_id=e.eid AND status='completed' AND pno IN (SELECT distinct pno from  `subtasks`  WHERE '$pid'= eid)";
